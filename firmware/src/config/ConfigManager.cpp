...
auto ConfigManager::load() -> bool {
    ...
    this->anthropic_token = secure.get("anthropic_token", "").c_str();
    this->webhook_url = secure.get("webhook_url", "").c_str();
...
auto ConfigManager::save() -> bool {
    ...
    secure.put("anthropic_token", this->anthropic_token.c_str());
    secure.put("webhook_url", this->webhook_url.c_str());
